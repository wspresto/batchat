...
$.widget( "mobile.textinput", {
	...
	_autoCorrect: function() {
		...
		if ( typeof this.element[0].autocorrect !== "undefined" &&
			...
			// is code that attempts to make modifications via template.
...
$.widget( "ui.tabs", {
	...
	_create: function() {
		...
		// Take disabling tabs via class attribute from template
	...
	refresh: function() {
		...
		// get disabled tabs from class attribute from template
